...
app_data_alumni.add_url_rule('/mahasiswa','mahasiswa',Data_alumniView().mahasiswa, methods=['GET'])
app_data_alumni.add_url_rule('/tambah_alumni/<int:id>','tambah_alumni',Data_alumniView().tambah_alumni, methods=['GET'])
